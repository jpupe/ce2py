...
with st.container():
    ...
    col2.metric(label="Mínimo de Preço", value=f'R$ {minpreco}')
    mpreco = float(dados["Preço"].mean())
    col2.metric(label="Média de Preço", value=f'R$ {mpreco}')
    maxpreco = float(dados["Preço"].max())
    col2.metric(label="Máximo de Preço", value=f'R$ {maxpreco}')
    minprecom2 = float(dados["Preço/m²"].min())
    col3.metric(label="Mínimo de Preço/m²", value=f'R$ {minprecom2}')
    mprecom2 = float(dados["Preço/m²"].mean())
    col3.metric(label="Média de Preço/m²", value=f'R$ {mprecom2}')
    maxprecom2 = float(dados["Preço/m²"].max())
    col3.metric(label="Máximo de Preço/m²", value=f'R$ {maxprecom2}')
